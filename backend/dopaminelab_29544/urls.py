"""dopaminelab_29544 URL Configuration
...
admin.site.site_header = "DopamineLab"
admin.site.site_title = "DopamineLab Admin Portal"
admin.site.index_title = "DopamineLab Admin"

# swagger
api_info = openapi.Info(
    title="DopamineLab API",
    default_version="v1",
    description="API documentation for DopamineLab App",
)
